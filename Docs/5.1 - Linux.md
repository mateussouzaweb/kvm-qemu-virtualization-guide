...
- 12 GB ram
- 2 disks as LVM partitions
- AMD GPU passthrough (not the main GPU)
...
<domain type='kvm'>
  ...
  <!-- Hooks -->
  <description>--gpu-passthrough=secondary,0000:08:00.0,0000:08:00.1 --scale-cpu --cpu-host-allow=0,1,8,9 --cpu-host-restore=0,15 --usb-passthrough=all</description>
  ...
  <devices>
    ...
    <disk type='block' device='disk'>
      ...
      <source dev='/dev/hypervisor/ubuntu'/>
