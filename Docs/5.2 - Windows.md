...
<domain type='kvm'>
  ...
  <!-- Hooks -->
  <description>--main-gpu-passthrough --scale-cpu --cpu-host-allow=0,1,8,9 --cpu-host-restore=0-15 --usb-passthrough=all</description>
  ...
  <devices>
    ...
    <hostdev mode='subsystem' type='pci' managed='yes'>
      ...
      <rom file='/usr/share/vgabios/GP104.rom'/>
    ...
    <!-- VirtIO disk - used only at installation -->
    <!--
